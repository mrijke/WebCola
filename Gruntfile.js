module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    browserify: {
      ...
      examples: {
        ...
        files: {
          ...
          "WebCola/examples/dotpowergraph.js": [
            "WebCola/examples/dotpowergraph.ts",
          ],
          "WebCola/examples/powergraphexample.js": [
            "WebCola/examples/powergraphexample.ts",
          ],
          "WebCola/examples/pretrip.js": ["WebCola/examples/pretrip.ts"],
          "WebCola/examples/statemachinepowergraph.js": [
            "WebCola/examples/statemachinepowergraph.ts",
          ],
      ...
      test: {
        files: {
          "WebCola/test/bundle.js": [
            "WebCola/test/vpsctests.js",
            "WebCola/test/apitests.js",
            "WebCola/test/tests.js",
            "WebCola/test/routingtests.js",
            "WebCola/test/gridrouting.js",
            "!WebCola/test/bundle.js" /*,'WebCola/test/matrixperftest.js'*/,
          ],
        },
        options: {
    ...
    uglify: {
      ...
      dist: {
        files: {
          "WebCola/cola.min.js": ["WebCola/cola.js"],
        },
      },
    },
    qunit: {
